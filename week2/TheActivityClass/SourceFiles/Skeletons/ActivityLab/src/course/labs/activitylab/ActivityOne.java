...
public class ActivityOne extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		launchActivityTwoButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent launchActivityTwoIntent = new Intent(ActivityOne.this, ActivityTwo.class);
				
				// Launch the Activity using the intent
				startActivity(launchActivityTwoIntent);
		...
		// Emit LogCat message
		logInfo("entered the onCreate() method");
	...
	public void onStart() {
		...
		//Emit LogCat message
		logInfo("entered the onStart() method");
	...
	public void onResume() {
		super.onResume();
		logInfo("entered the onResume() method");
	...
	public void onPause() {
		...
		//Emit LogCat message
		logInfo("entered the onPause() method");
	...
	public void onStop() {
		super.onStop();
		logInfo("entered the onStop() method");
	}

	@Override
	public void onRestart() {
		super.onRestart();
		logInfo("entered the onRestart() method");
	...
	public void onDestroy() {
		...
		logInfo("entered the onDestroy() method");
	}
