...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent launchExplicitlyLoadedActivity = new Intent(this, ExplicitlyLoadedActivity.class);
		
		// Start an Activity using that intent and the request code defined above
		startActivityForResult(launchExplicitlyLoadedActivity, GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
		...
		Intent chooserIntent = Intent.createChooser(implicitIntent, "Choose My Browser to view this");
